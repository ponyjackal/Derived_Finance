...
const Questions = ({ index, questionId, title, status, meta, long, short }) => {
        ...
        <div className=" bg-secondary mx-5 mb-5 rounded-lg cursor-pointer">
          <div className="flex items-center md:flex-row flex-col p-6 w-full">
            <div className="flex md:flex-col flex-col w-64">
              <p className="text-white text-xl p-2">Question {index}</p>
              <p
              ...
              <p className="text-white text-xl p-2">Status : {status}</p>
            </div>
            <hr className="w-px h-36 bg-gray-200 mx-3" style={{ minWidth: '1px' }} />
            <div className="flex w-full items-start flex-col" style={{ width: 'calc(100% - 18rem)' }}>
              <p
