...
async function main() {
  ...
  console.log(
    ...
    ethers.utils.hexDataSlice(ethers.utils.formatBytes32String("XDR"), 0, 4)
  );
  ...
  const safeDecimalMath = await SafeDecimalMath.attach(
    "0x43A879F255DE08d049A2620cBe3A5aa928eb02fb"
  );
  ...
  const feePool = await FeePool.attach(
    "0x0f79EA9DE4768eA4BFE54d95560B099cDC7f193C" // The deployed contract address
  );
