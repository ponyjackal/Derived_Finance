...
// Deploy only Synth
async function main() {
    console.log("process.env.NODE_ENV", process.env.NODE_ENV, path.resolve(`${__dirname}/../../.env.${process.env.NODE_ENV}`))
    console.log("owner", owner);

    console.log(require("dotenv").config({ path: path.resolve(`${__dirname}/../../.env.${process.env.NODE_ENV}`)}))
