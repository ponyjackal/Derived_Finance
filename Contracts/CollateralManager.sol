...
contract CollateralManager is ICollateralManager, Owned, Pausable, MixinResolver {
    ...
    function isSynthManaged(bytes32 currencyKey) external override view returns (bool) {
    ...
    function hasCollateral(address collateral) public override view returns (bool) {
    ...
    function long(bytes32 synth) external override view returns (uint amount) {
        return state.long(synth);
    }

    function short(bytes32 synth) external override view returns (uint amount) {
        return state.short(synth);
    }

    function totalLong() public override view returns (uint USDxValue, bool anyRateIsInvalid) {
    ...
    function totalShort() public override view returns (uint USDxValue, bool anyRateIsInvalid) {
    ...
    function getBorrowRate() external override view returns (uint borrowRate, bool anyRateIsInvalid) {
    ...
    function getShortRate(bytes32 synth) external override view returns (uint shortRate, bool rateIsInvalid) {
    ...
    function exceedsDebtLimit(uint amount, bytes32 currency) external override view returns (bool canIssue, bool anyRateIsInvalid) {
        ...
        returns (bool)
    {
        ...
        // now check everything added to external override state contract
