...
contract ExchangeState is Owned, State, IExchangeState {
    ...
    function appendExchangeEntry(
        ...
        uint roundIdForSrc,
        uint roundIdForDest
    ) external override onlyAssociatedContract {
    ...
    function removeEntries(address account, bytes32 currencyKey) external override onlyAssociatedContract {
        delete exchanges[account][currencyKey];
    }

    /* ========== VIEWS ========== */

    function getLengthOfEntries(address account, bytes32 currencyKey) external override view returns (uint) {
    ...
    function getMaxTimestamp(address account, bytes32 currencyKey) external override view returns (uint) {
