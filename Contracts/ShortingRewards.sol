...
contract ShortingRewards is IShortingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable, MixinResolver {
    ...
    function enrol(address account, uint256 amount) external override onlyShortContract nonReentrant notPaused updateReward(account) {
    ...
    function withdraw(address account, uint256 amount) external override onlyShortContract nonReentrant updateReward(account) {
    ...
    function getReward(address account) external override onlyShortContract nonReentrant updateReward(account) {
