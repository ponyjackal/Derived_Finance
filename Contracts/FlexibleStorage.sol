...
contract FlexibleStorage is ContractStorage, IFlexibleStorage {
    ...
    function getUIntValue(bytes32 contractName, bytes32 record) external override view returns (uint) {
        return uintStorage[hashes[contractName]][record];
    }

    function getUIntValues(bytes32 contractName, bytes32[] calldata records) external override view returns (uint[] memory) {
    ...
    function getIntValue(bytes32 contractName, bytes32 record) external override view returns (int) {
        return intStorage[hashes[contractName]][record];
    }

    function getIntValues(bytes32 contractName, bytes32[] calldata records) external override view returns (int[] memory) {
    ...
    function getAddressValue(bytes32 contractName, bytes32 record) external override view returns (address) {
        return addressStorage[hashes[contractName]][record];
    }

    function getAddressValues(bytes32 contractName, bytes32[] calldata records) external override view returns (address[] memory) {
    ...
    function getBoolValue(bytes32 contractName, bytes32 record) external override view returns (bool) {
        return boolStorage[hashes[contractName]][record];
    }

    function getBoolValues(bytes32 contractName, bytes32[] calldata records) external override view returns (bool[] memory) {
    ...
    function getBytes32Value(bytes32 contractName, bytes32 record) external override view returns (bytes32) {
        return bytes32Storage[hashes[contractName]][record];
    }

    function getBytes32Values(bytes32 contractName, bytes32[] calldata records) external override view returns (bytes32[] memory) {
    ...
    function setUIntValue(
        ...
        bytes32 record,
        uint value
    ) external override onlyContract(contractName) {
    ...
    function deleteUIntValue(bytes32 contractName, bytes32 record) external override onlyContract(contractName) {
    ...
    function deleteIntValue(bytes32 contractName, bytes32 record) external override onlyContract(contractName) {
    ...
    function deleteAddressValue(bytes32 contractName, bytes32 record) external override onlyContract(contractName) {
    ...
    function deleteBoolValue(bytes32 contractName, bytes32 record) external override onlyContract(contractName) {
    ...
    function deleteBytes32Value(bytes32 contractName, bytes32 record) external override onlyContract(contractName) {
